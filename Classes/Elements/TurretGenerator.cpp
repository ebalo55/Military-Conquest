...
TurretGenerator::TurretGenerator(sf::RenderWindow *window, sf::Font *font, EventHandler *eventHandler, Map *map, bool is_easy, Tower *tower, sf::Texture *texture) {
    ...
    this->initialized_instances = is_easy ? std::vector<Turret *> {
            ...
            new Turret(tower, texture, 5, Turret::TurretStats{8, 4, 10, 3, 80, 200, 200, 0, 0, "Turret 1"},
                       TURRET_TYPE::turret1),
            new Turret(tower, texture, 6, Turret::TurretStats{10, 5, 13, 2, 60, 200, 200, 0, 0, "Turret 2"},
                       TURRET_TYPE::turret2),
            new Turret(tower, texture, 7, Turret::TurretStats{15, 5, 20, 5, 100, 200, 200, 0, 0, "Turret 3"},
...
void TurretGenerator::generateInstancesMap() {
    ...
    for (Turret *turret : initialized_instances) {
        ...
        button = factory.instantiateButtonRect(turret->getTurretName() + "-craft",
                                               ...
                                               sf::Color(0, 0, 0),
                                               sf::Vector2f{WINDOW_WIDTH - 40,
                                                            (float) (WINDOW_HEIGHT - (-35 + positional_factor))});
...
TurretGenerator *TurretGenerator::selectTurret(TURRET_TYPE turret) {
    selected_turret =
            turret == ::turret1 ? turret1 : turret == ::turret2 ? turret2 : turret == ::turret3 ? turret3 : turret ==
                                                                                                            ::turret4
                                                                                                            ? turret4
                                                                                                            : turret5;
    return this;
